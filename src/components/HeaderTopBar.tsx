...
import Call from "../icons/call_black.svg";
import message from "../icons/messages.png";
import Facebook from "../icons/Vector.svg";
import Twitter from "../icons/Vector(1).svg";
import Instagram from "../icons/Vector(2).svg";
import LinkedIn from "../icons/Vector(3).svg";
import Pinterest from "../icons/Vector(4).svg";
