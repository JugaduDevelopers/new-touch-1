        ...
        <div>
          <div className="relative  sm:max-w-5xl    rounded-xl ">
            ...
            >
              ...
              <div className="absolute -bottom-[23px] left-0  w-full flex justify-center items-center z-50 px-7">
                <div className="h-[3px] w-full bg-whiteX"></div>
                <div className="cursor-pointer p-2 aspect-square rounded-full bg-whiteX flex items-center justify-center border-black border-[1px] border-opacity-25">
                  <h6 className="text-black text-xs">Drag</h6>
                </div>
                <div className="h-[3px] w-full bg-whiteX"></div>
              </div>
            </div>
            <div className="absolute top-0 left-0 z-20 w-full aspect-auto bg-slate-300 rounded-3xl overflow-hidden">
              <Image src={Image3} alt="dragablePic" className="w-full h-full" />
            </div>
          </div>
        </div>
      </div>
